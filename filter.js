...
// console.log(filterByValue([{first: 'Elie', last:"Schoppik"}, {first: 'Tim', last:"Garcia", isCatOwner: true}, {first: 'Matt', last:"Lane"},
...
function removeVowels(str){
  let exp = str.toLowerCase().split('');
  let vowels = ['a','e','i','o','u'];
  return exp.filter(function(value) {
